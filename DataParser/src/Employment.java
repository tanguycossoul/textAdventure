...
//        return fields;
//    }
//    private static double avrvirgcounties(TimeFrame time) {
//        for (int i = 0; i < education.length(); i++) {
//extractCleanFields(education.get line(i));
////TODO: extract ememployment field and find the average of all the counties in virginia (keep in mind time frame(make method to get only the lines with the right years)
//        }
//    }
//
//    public static double avgallcounties (int start, int end) {
//        TimeFrame
//        int rangeMax = time.getmax()
//       double avg = 0;
//        for (int i = 0; i <employment.length() ; i++) {
//            if( line year(i) <= rangeMin && line year(i) <= rangeMax)
//
//        }
//        //TODO: extract employment and find average or all counties in U.S.(keep in mind the time frame (make helper method for this))
//    return avg;
//    }
//
